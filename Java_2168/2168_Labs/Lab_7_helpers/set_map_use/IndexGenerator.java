...
package Lab_7_helpers.set_map_use;
...
public class IndexGenerator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            scan = new Scanner(new FileReader(new File("D:\\Programming\\Java_Files&Scripts\\Java_2168\\2168_Labs\\Lab_7_helpers\\set_map_use\\test_file_4_word_index.txt")));
