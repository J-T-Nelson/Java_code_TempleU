 ...
 * @author Koffman and Wolfgang & Cindy
 **/
public class TwoDimGrid extends JPanel {

    //COLOR CONSTANTS for Image Processing Case Study
    static final Color NORMAL = Color.white;
    static final Color ABNORMAL = Color.GRAY;    
    static final Color BACKGROUND = NORMAL;    
    static final Color NON_BACKGROUND = ABNORMAL;      
